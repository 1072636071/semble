...
- **[git-guardrails-claude-code](./misc/jxx-git-guardrails-claude-code/SKILL.md)** — 设置 Claude Code hooks，在危险 git 命令执行前将其拦截。
...
- **[setup-pre-commit](./misc/jxx-setup-pre-commit/SKILL.md)** — 设置 Husky pre-commit hooks。
