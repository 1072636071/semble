---
name: skill-creator
description: 创建（或更新）高效 skill 的指南 Guide for creating/updating effective skills；当用户需要新建或改进扩展 Agent 能力的 skill（含 specialized knowledge、workflows、tool integrations）时使用。
metadata:
  version: 1.0.3
---
...
3. Resolve Licensing (`LICENSE.md`)
...
* **Custom Behavior (Explicit request):** If the user specifically requested a different license (e.g., MIT, GPL-3.0), generate the full, standard text for that specific license and write it into `LICENSE.md`.
