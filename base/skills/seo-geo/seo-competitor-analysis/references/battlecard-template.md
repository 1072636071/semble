...
每个主要竞品维护一张 battlecard。受众：销售、内容策略与营销领导层。每季度复盘，并在 pricing、feature、融资、review 趋势或赢/输变化后立即更新。
...
- [ ] pricing、套餐与隐藏费用已用来源日期验证。
- [ ] 新功能发布已反映到对比与异议处理。
- [ ] 已查最新 G2/Capterra/review 趋势。
- [ ] 赢/输笔记已用近期销售反馈更新。
- [ ] SEO/GEO 指标已用来源与日期刷新。
- [ ] 差异化与 landmine 问题已与销售测试。
- [ ] 证据陈旧或不全时调整置信度。
