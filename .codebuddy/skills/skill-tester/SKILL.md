...
name: skill-tester
description: >
  Automated evaluations for a project-level skill using a specified JSON test suite.
  Always trigger this skill whenever the user says "test skill", "evaluate skill", or similar phrases.
metadata:
  version: 1.1.0
---
